...
For a fluid region that is not the entirety of $\mathbb{R}^3$, boundary conditions must be specified, which define the behaviour of the fluid on the physical boundaries of the fluid region.
