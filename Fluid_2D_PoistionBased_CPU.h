...
class Fluid_2D_PositionBased_CPU: public Fluid_2D{
public:
    ...
    void computeSpacing(){
        ...
        std::cout<<"  which is  "<<precomputedSpacing/particleRadius<<"  times particle radius"<<std::endl;
    }

    Fluid_2D_PositionBased_CPU(){
